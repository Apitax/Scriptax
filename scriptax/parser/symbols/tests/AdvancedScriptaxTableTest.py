...
module_table.new(name="basemodule", path="std.base.module") # The strings class extends std.base.module
...
# After completing the std.base.module extension of strings, we find other symbols and methods inside of the string class
...
instance.new(name="basemodule", path="std.base.module") # The strings class extends std.base.module
...
# FILE: std.strings
# from std.base import module as basemodule;
# extend basemodule;
